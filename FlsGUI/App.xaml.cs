...
namespace FLS
{
    ...
    public partial class App
    {
        ...
        protected override void OnStartup(StartupEventArgs e)
        {
            ...
            //Initialize Database
            CreateIfNotExists("FlsDatabase.sdf");
        ...
        {
            var splashScreen = new SplashScreen("resources/startupLogo_FLS.png");
        ...
        private static void OpenMainWindow()
        {
            ...
            DashboardPageViewModel.Instance.WelcomeUserTitle = $"Bienvenue {userConnected?.FirstName} {userConnected?.LastName}";
        ...
        private static void CreateIfNotExists(string fileName)
        {
            ...
            if (!File.Exists($"{motsFilePath}\\{fileName}"))
            {
                ...
                File.Copy($"{exePath}\\Resources\\{fileName}", $"{motsFilePath}\\{fileName}");
