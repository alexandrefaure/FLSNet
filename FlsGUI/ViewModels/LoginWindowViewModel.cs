...
namespace FLS.ViewModels
{
    public class LoginWindowViewModel : DataErrorInfo, INotifyPropertyChanged
    {
        ...
        public LoginWindowViewModel()
        {
            ...
            {
                IsFirstLogin = true;
                WindowTitle = "Première Connexion à FLSNet";
                ConnectionTitleFormText = "Bienvenue dans FLSNet";
                SaveConnectButtonText = "Enregistrer";
            }
            else
            {
                IsFirstLogin = false;
                WindowTitle = "Connexion à FLSNet";
                ConnectionTitleFormText = "Connectez-vous à FLSNet";
